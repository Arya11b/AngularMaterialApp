...
describe('TreeFieldComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TreeFieldComponent , SignFormComponent, MessagesComponent , HeroTodoComponent , HeroDetailComponent , HeroProfileComponent , HeroEditComponent , HomeComponent  ],
